...
export class DanhMucServiceProxy {
     ...
     * @return Success
     */
    saveDanhMuc(data: DanhMucDto | null | undefined): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/DanhMuc/SaveDanhMuc";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSaveDanhMuc(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSaveDanhMuc(<any>response_);
                } catch (e) {
                    return <Observable<number>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSaveDanhMuc(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    deleteDanhMuc(id: number | null | undefined): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/DanhMuc/DeleteDanhMuc?";
        if (id !== undefined)
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteDanhMuc(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteDanhMuc(<any>response_);
                } catch (e) {
                    return <Observable<number>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteDanhMuc(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class TinTucServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getDanhSach(filter: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfTinTucDto> {
        let url_ = this.baseUrl + "/api/services/app/TinTuc/GetDanhSach?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
    ...
    protected processGetDanhSach(response: HttpResponseBase): Observable<PagedResultDtoOfTinTucDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    saveTinTuc(input: TinTucDto | null | undefined): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/TinTuc/SaveTinTuc";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSaveTinTuc(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSaveTinTuc(<any>response_);
                } catch (e) {
                    return <Observable<number>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSaveTinTuc(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    changeTrangThai(input: XoaTinTucDto | null | undefined): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/TinTuc/ChangeTrangThai";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processChangeTrangThai(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processChangeTrangThai(<any>response_);
                } catch (e) {
                    return <Observable<number>><any>_observableThrow(e);
                }
            } else
    ...
    protected processChangeTrangThai(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class DanhMucDto implements IDanhMucDto {
    ...
    static fromJS(data: any): DanhMucDto {
        data = typeof data === 'object' ? data : {};
        let result = new DanhMucDto();
        result.init(data);
        return result;
    }
...
export class AppQuanLyNhuanDto implements IAppQuanLyNhuanDto {
    ...
    appNhanSuRef!: number | undefined;
    chuyenMuc!: string | undefined;
    viTri!: string | undefined;
    appButDanhRef!: string | undefined;
    tenBaiViet!: string | undefined;
    appLoaiBaiRef!: string | undefined;
    trangThai!: number | undefined;
    tyLe!: number | undefined;
    appHangREF!: number | undefined;
    tongSoLuongAnh!: number | undefined;
    slaa!: number | undefined;
    slab!: number | undefined;
    slac!: number | undefined;
    tongTienNhuanAnh!: number | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.appNhanSuRef = data["appNhanSuRef"];
            this.chuyenMuc = data["chuyenMuc"];
            this.viTri = data["viTri"];
            this.appButDanhRef = data["appButDanhRef"];
            this.tenBaiViet = data["tenBaiViet"];
            this.appLoaiBaiRef = data["appLoaiBaiRef"];
            this.trangThai = data["trangThai"];
            this.tyLe = data["tyLe"];
            this.appHangREF = data["appHangREF"];
            this.tongSoLuongAnh = data["tongSoLuongAnh"];
            this.slaa = data["slaa"];
            this.slab = data["slab"];
            this.slac = data["slac"];
            this.tongTienNhuanAnh = data["tongTienNhuanAnh"];
    ...
    toJSON(data?: any) {
        ...
        data["appNhanSuRef"] = this.appNhanSuRef;
        data["chuyenMuc"] = this.chuyenMuc;
        data["viTri"] = this.viTri;
        data["appButDanhRef"] = this.appButDanhRef;
        data["tenBaiViet"] = this.tenBaiViet;
        data["appLoaiBaiRef"] = this.appLoaiBaiRef;
        data["trangThai"] = this.trangThai;
        data["tyLe"] = this.tyLe;
        data["appHangREF"] = this.appHangREF;
        data["tongSoLuongAnh"] = this.tongSoLuongAnh;
        data["slaa"] = this.slaa;
        data["slab"] = this.slab;
        data["slac"] = this.slac;
        data["tongTienNhuanAnh"] = this.tongTienNhuanAnh;
...
export class TinTucDto implements ITinTucDto {
    ...
    userId!: number | undefined;
    danhMucId!: number | undefined;
    trangThai!: number | undefined;
    ngayThem!: string | undefined;
    ngaySua!: string | undefined;
    id!: number | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.userId = data["userId"];
            this.danhMucId = data["danhMucId"];
            this.trangThai = data["trangThai"];
            this.ngayThem = data["ngayThem"];
            this.ngaySua = data["ngaySua"];
            this.id = data["id"];
        }
    }
...
export class XoaTinTucDto implements IXoaTinTucDto {
    trangThai!: number | undefined;
    isDelete!: number | undefined;
    id!: number | undefined;

    constructor(data?: IXoaTinTucDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): XoaTinTucDto {
        data = typeof data === 'object' ? data : {};
        let result = new XoaTinTucDto();
        result.init(data);
        return result;
    }
...
export interface IXoaTinTucDto {
    trangThai: number | undefined;
    isDelete: number | undefined;
    id: number | undefined;
}
