...
using Center.Production.Chat;
using Center.Production.Editions;
using Center.Production.Friendships;
...
{
    public class ProductionDbContext : AbpZeroDbContext<Tenant, Role, User, ProductionDbContext>, IAbpPersistedGrantDbContext
    {
